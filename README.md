[![Build Status](https://github.com/opspec-pkgs/npm.pkg.set-version/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/npm.pkg.set-version/actions?query=workflow%3Abuild+branch%3Amain)
